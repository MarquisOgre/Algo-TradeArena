    ...
    <div className="lovable-landing">
      <main id="top" className="site-shell">
        ...
        <section className="lower-grid section-wrap">
          ...
          <article id="wallet" className="devices"><h3>Trade Anywhere</h3><p>Seamless access on all your devices.</p><div className="device-art" aria-hidden="true"><div className="device-laptop"><div className="screen-ui"><div className="screen-top" /><div className="screen-side" /><div className="screen-chart"><i /><i /><i /><i /><i /></div><div className="screen-cards"><span /><span /><span /><span /></div></div><div className="laptop-base" /></div><div className="device-phone phone-left"><div /></div><div className="device-phone phone-mid"><div /></div><div className="device-phone phone-right"><div /></div></div><ul>{["Web Platform", "iOS App", "Android App", "Connect Wallet", "Connect MT5"].map(x => <li key={x}><Check size={14} />{x}</li>)}</ul><a className="outline-action" href="/app">Start Trading Anywhere <ArrowRight size={16} /></a></article>
        </section>
