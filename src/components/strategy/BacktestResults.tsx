...
export function BacktestResults({ definition, strategyName = "Strategy Lab Draft" }: { definition: StrategyRuleDefinition; strategyName?: string }) {
  ...
  const run = async () => {
    ...
    try {
      ...
      setResult(next.result); setBacktestId(next.backtestId);
    } catch (e) {
