  ...
  return (
    <AppShell wide>
      <PageHeader
        ...
        description="A completely separate trading environment for connected Pepperstone MetaTrader 5 Live accounts. Pepperstone MT5 Demo is reserved for Paper Trading; demo positions and demo P&L never appear here."
      />
        ...
        <div className="grid gap-6 p-6 md:grid-cols-[auto_1fr] md:items-center md:p-8">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-lg font-bold text-foreground">Connect Pepperstone MT5 Live</h2>
            ...
            <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
              Live Trading will use your connected Pepperstone MT5 Live account. It does not receive the $100,000 Paper Trading allocation and it does not share the Paper Trading wallet, positions, orders or P&L.
            </p>
      ...
      <div className="mt-4 flex items-start gap-3 rounded-xl border border-border bg-muted/30 p-4 text-xs text-muted-foreground">
        ...
        <p>ALPHENTRA keeps Paper Trading and Live Trading as separate account domains. Live-order routing will use the separate Pepperstone MT5 Live environment and requires explicit live authorization. Paper Trading never routes orders to this account.</p>
      </div>
    </AppShell>
  );
}
